...
export const PRESETS = {
  ...
  mono: {
    ...
    colors: { top: '#E6B400', right: '#E6B400', left: '#E6B400' },
    bgColor: '#0A0A0F', stroke: '#0A0A0F', strokeWidth: 1.5,
  ...
  star: {
    ...
    colors: { top: '#E6B400', right: '#FCD34D', left: '#9A7D0A' },
    bgColor: '#0A0A0F', stroke: '#0A0A0F', strokeWidth: 0,
...
export const PALETTES: readonly Palette[] = [
  { name: 'Gold (angee)',  top: '#FCD34D', right: '#E6B400', left: '#9A7D0A' },
  ...
  { name: 'Mono — gold',   top: '#E6B400', right: '#E6B400', left: '#E6B400' },
